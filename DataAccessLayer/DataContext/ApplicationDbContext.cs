    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AdminRegion>(entity =>
        {
            ...
            entity.HasOne(d => d.Admin).WithMany(p => p.AdminRegions)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("admin_region_adminid_fkey");

            entity.HasOne(d => d.Region).WithMany(p => p.AdminRegions)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("admin_region_regionid_fkey");
        });
        ...
        {
            entity.HasKey(e => new { e.Userid, e.Roleid }).HasName("aspnet_userroles_pkey");

            entity.HasOne(d => d.User).WithMany(p => p.AspnetUserroles)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("aspnet_userroles_userid_fkey");
        });
        ...
        modelBuilder.Entity<Healthprofessional>(entity =>
        {
            ...
            entity.HasOne(d => d.HealthprofessionalNavigation).WithMany(p => p.Healthprofessionals).HasConstraintName("healthprofessionals_healthprofessionalid_fkey");
        });
        ...
        modelBuilder.Entity<PhysicianLocation>(entity =>
        {
            ...
            entity.HasOne(d => d.Physician).WithMany(p => p.PhysicianLocations)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("physician_location_physicianid_fkey");
        });
        ...
        modelBuilder.Entity<PhysicianNotification>(entity =>
        {
            ...
            entity.HasOne(d => d.Physician).WithMany(p => p.PhysicianNotifications)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("physician_notification_physicianid_fkey");
        });
        ...
        modelBuilder.Entity<PhysicianRegion>(entity =>
        {
            ...
            entity.HasOne(d => d.Physician).WithMany(p => p.PhysicianRegions)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("physician_region_physicianid_fkey");

            entity.HasOne(d => d.Region).WithMany(p => p.PhysicianRegions)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("physician_region_regionid_fkey");
        });
